  ...
  return (
    <div className="App">
      ...
      <header className="App-header">
        ...
        <a href="https://blacklivesmatters.carrd.co/"><h2 className="BLM"> BLACK <br/> LIVES <br/> MATTER</h2></a>
        ...
        <div className="col-3-zip">
            ...
            <input class="effect-5" type="text" onClick={this.showButton} onChange={(e) => this.zipChangeHandler(e)} placeholder="ENTER ZIPCODE" type="text" pattern="[0-9]*"/>
